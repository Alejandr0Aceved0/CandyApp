...
public class SeccionClosets extends AppCompatActivity {
    ...
    Integer[] images  = {R.drawable.closet_beige_1          , R.drawable.closet_beige_2          , R.drawable.closet_beige_3 , R.drawable.closet_beige_4};
    Integer[] images2 = {R.drawable.closet_cafe_1           , R.drawable.closet_cafe_2           , R.drawable.closet_cafe_3  , R.drawable.closet_cafe_4};
