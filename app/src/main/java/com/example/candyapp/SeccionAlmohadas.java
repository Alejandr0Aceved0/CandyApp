...
public class SeccionAlmohadas extends AppCompatActivity {
    ...
    Integer[] images  = {R.drawable.cervical_memory_1 ,R.drawable.cervical_memory_3 ,R.drawable.cervical_memory_4};
    Integer[] images2 = {R.drawable.anti_static_1, R.drawable.anti_static_2, R.drawable.anti_static_3};
    Integer[] images3 = {R.drawable.almh_power_cool1, R.drawable.almh_power_cool2, R.drawable.almh_power_cool4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn_salir       =(Button)     findViewById(R.id.fab);
        ...
        Btn_salir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SeccionAlmohadas.this, MenuPrincipal.class);
