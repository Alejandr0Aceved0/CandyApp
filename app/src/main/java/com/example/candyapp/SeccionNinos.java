...
public class SeccionNinos extends AppCompatActivity {
    ...
    Integer[] images  = {R.drawable.cuna_1          , R.drawable.cuna_2};
    Integer[] images2 = {R.drawable.osito_1         , R.drawable.osito_2};
