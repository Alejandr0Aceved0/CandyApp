...
public class SeccionColchones extends AppCompatActivity {
    ...
    Integer[] images  = {R.drawable.colchon_pocket_1          , R.drawable.colchon_pocket_2          , R.drawable.colchon_pocket_3};
    Integer[] images2 = {R.drawable.colchon_super_ortopedico_1, R.drawable.colchon_super_ortopedico_2, R.drawable.colchon_super_ortopedico_3};
    Integer[] images3 = {R.drawable.colchon_esmeralda_1       , R.drawable.colchon_esmeralda_2       , R.drawable.colchon_esmeralda_1};
